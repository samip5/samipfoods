...
public class ModBlocks {
	...
	*/
	...
	public static void init() {
		cheeseblock = register(new BlockBase(Material.ROCK, "CheeseBlock").setCreativeTab(InitCreativeTabs.TestTab), null);
		cropStrawberry = register(new BlockCropStrawberry(), null);
		saltBlock = register(new SaltBlock(), null);
		tinOre = register(new BlockTinOre(), null);
	}
